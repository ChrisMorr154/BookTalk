...
const Feed = () => {
  ...
  const [posts, setPosts] = useState(() => {
    ...
    if (!storedPosts) {
      return [{
        ...
        content: "This is our first post on the social network to talk about your favorite books. Stay tuned for more updates!",
        image: "",
        author: "System",
  ...
  if (postContent.trim() !== "") {
    ...
    // put new post at the *front* of the array
  ...
  // Reply logic **Need to allow users to reply to reply's**
